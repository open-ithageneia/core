...
> = {
	...
	listening: {
		...
		description:
			"Μία τυχαία ακουστική ερώτηση. Κάθε σωστή πρόταση Σωστό/Λάθος και κάθε σωστή ερώτηση πολλαπλής επιλογής μετράει 1,5 μονάδα. Έχετε 15 λεπτά στη διάθεσή σας.",
	},
}
