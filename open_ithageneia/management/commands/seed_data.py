...
from open_ithageneia.admin import QuizQuestionAdmin
from open_ithageneia.models import QuizQuestionTypeModel, QuizCategoryModel, Semester, QuizQuestionItemModel, \
    QuizQuestionModel, MappingGroupModel, MappingPairModel
...
class Command(BaseCommand):
    ...
    def seed_semester():
        Semester.objects.get_or_create(
            year=2026,
            half=Semester.SemesterHalf.First
        )

        Semester.objects.get_or_create(
            year=2026,
            half=Semester.SemesterHalf.Second
        )
    ...
    def add_map_sample(semester, category, q_type, number):
        ...
        # Mapping groups
        group_countries = MappingGroupModel.objects.get_or_create(
            question=q,
            is_first=True,
            type=MappingGroupModel.GroupType.Choices,
            defaults={"name": "Χώρες"}
        )[0]

        group_capitals = MappingGroupModel.objects.get_or_create(
            question=q,
            is_first=False,
            type=MappingGroupModel.GroupType.Choices,
        ...
        # Mapping pairs
        MappingPairModel.objects.get_or_create(first=greece, second=athens)
        MappingPairModel.objects.get_or_create(first=france, second=paris)
    ...
    def add_cat_sample(semester, category, q_type, number):
        ...
        group_categories = MappingGroupModel.objects.get_or_create(
            question=q,
            type=MappingGroupModel.GroupType.Categories,
            is_first=True,
        )[0]

        group_areas = MappingGroupModel.objects.get_or_create(
            question=q,
            type=MappingGroupModel.GroupType.Choices,
            is_first=False,
        )[0]
        ...
        land = QuizQuestionItemModel.objects.get_or_create(
            question=q,
            mapping_group=group_categories,
        ...
        MappingPairModel.objects.get_or_create(first=alexandroupoli, second=land)
        MappingPairModel.objects.get_or_create(first=pyrgos, second=land)
        MappingPairModel.objects.get_or_create(first=sifnos, second=sea)
    ...
    def add_gf_sample(semester, category, q_type, number):
        ...
        group_choices = MappingGroupModel.objects.get_or_create(
            question=q,
            type=MappingGroupModel.GroupType.Choices,
        )[0]

        group_blanks = MappingGroupModel.objects.get_or_create(
            question=q,
            type=MappingGroupModel.GroupType.Blanks,
        )[0]

        hatzidakis = QuizQuestionItemModel.objects.get_or_create(
            question=q,
            mapping_group=group_choices,
            text=" Μάνος Χατζηδάκι"
        )[0]

        reboutsika = QuizQuestionItemModel.objects.get_or_create(
            question=q,
            mapping_group=group_choices,
            text="Ευανθία Ρεμπούτσικα"
        )[0]

        hatzidakis_blank = QuizQuestionItemModel.objects.get_or_create(
            question=q,
            mapping_group=group_blanks,
        ...
        MappingPairModel.objects.get_or_create(first=hatzidakis, second=hatzidakis_blank)
        MappingPairModel.objects.get_or_create(first=reboutsika, second=reboutsika_blank)
    ...
    def add_gf_2_sample(semester, category, q_type, number):
        ...
        group_answers = MappingGroupModel.objects.get_or_create(
            question=q,
            type=MappingGroupModel.GroupType.Choices,
        )[0]
        ...
        ans4 = QuizQuestionItemModel.objects.get_or_create(
            question=q,
            mapping_group=group_answers,
            text="την ιδιότητα του Έλληνα πολίτη"
        )[0]
        ...
        MappingPairModel.objects.get_or_create(first=ans1, second=blank_2)
        MappingPairModel.objects.get_or_create(first=ans2, second=blank_3)
        MappingPairModel.objects.get_or_create(first=ans3, second=blank_4)
        MappingPairModel.objects.get_or_create(first=ans4, second=blank_1)
    ...
    def add_gfmc_sample(semester, category, q_type, number):
        ...
        choices_1 = MappingGroupModel.objects.get_or_create(
            question=q,
            type=MappingGroupModel.GroupType.Choices,
        )[0]
        ...
        MappingPairModel.objects.get_or_create(first=choice_1, second=blank_1)

        choices_2 = MappingGroupModel.objects.get_or_create(
            question=q,
            type=MappingGroupModel.GroupType.Choices,
        )[0]
        ...
        MappingPairModel.objects.get_or_create(first=choice_2, second=blank_2)
