    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.PositiveSmallIntegerField(choices=[(1, 'Geographic department (Γεωγραφικό διαμέρισμα)'), (2, 'Region (Περιφέρεια)'), (3, 'Prefecture unit (Νομός / Νησί)'), (4, 'Municipality (Δήμος)')], default=4, help_text='Administrative division level used for the map.')),
