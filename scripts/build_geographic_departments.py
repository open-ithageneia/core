...
DEPARTMENTS = {
    "thrace": ("Θράκη", "Thrace", [
        "ΕΒΡΟΥ", "ΞΑΝΘΗΣ", "ΡΟΔΟΠΗΣ",
    ]),
    "macedonia": ("Μακεδονία", "Macedonia", [
        "ΔΡΑΜΑΣ", "ΘΑΣΟΥ", "ΚΑΒΑΛΑΣ", "ΣΕΡΡΩΝ", "ΘΕΣΣΑΛΟΝΙΚΗΣ", "ΗΜΑΘΙΑΣ",
        "ΚΙΛΚΙΣ", "ΠΕΛΛΑΣ", "ΠΙΕΡΙΑΣ", "ΧΑΛΚΙΔΙΚΗΣ", "ΓΡΕΒΕΝΩΝ", "ΚΑΣΤΟΡΙΑΣ",
        "ΚΟΖΑΝΗΣ", "ΦΛΩΡΙΝΑΣ",
    ]),
    "epirus": ("Ήπειρος", "Epirus", [
        "ΑΡΤΑΣ", "ΘΕΣΠΡΩΤΙΑΣ", "ΙΩΑΝΝΙΝΩΝ", "ΠΡΕΒΕΖΑΣ",
    ]),
    "thessaly": ("Θεσσαλία", "Thessaly", [
        "ΚΑΡΔΙΤΣΑΣ", "ΛΑΡΙΣΑΣ", "ΜΑΓΝΗΣΙΑΣ", "ΤΡΙΚΑΛΩΝ", "ΣΠΟΡΑΔΩΝ",
    ]),
    "central_greece": ("Στερεά Ελλάδα", "Central Greece", [
        "ΑΙΤΩΛΟΑΚΑΡΝΑΝΙΑΣ", "ΒΟΙΩΤΙΑΣ", "ΕΥΒΟΙΑΣ", "ΕΥΡΥΤΑΝΙΑΣ", "ΦΘΙΩΤΙΔΑΣ",
        "ΦΩΚΙΔΑΣ", "ΑΝΑΤΟΛΙΚΗΣ ΑΤΤΙΚΗΣ", "ΔΥΤΙΚΗΣ ΑΤΤΙΚΗΣ",
        "ΒΟΡΕΙΟΥ ΤΟΜΕΑ ΑΘΗΝΩΝ", "ΔΥΤΙΚΟΥ ΤΟΜΕΑ ΑΘΗΝΩΝ",
        "ΚΕΝΤΡΙΚΟΥ ΤΟΜΕΑ ΑΘΗΝΩΝ", "ΝΟΤΙΟΥ ΤΟΜΕΑ ΑΘΗΝΩΝ", "ΠΕΙΡΑΙΩΣ", "ΝΗΣΩΝ",
    ]),
    "peloponnese": ("Πελοπόννησος", "Peloponnese", [
        "ΑΡΓΟΛΙΔΑΣ", "ΑΡΚΑΔΙΑΣ", "ΚΟΡΙΝΘΙΑΣ", "ΛΑΚΩΝΙΑΣ", "ΜΕΣΣΗΝΙΑΣ",
        "ΑΧΑΪΑΣ", "ΗΛΕΙΑΣ",
    ]),
    "ionian_islands": ("Νησιά Ιονίου", "Ionian Islands", [
        "ΚΕΡΚΥΡΑΣ", "ΚΕΦΑΛΛΗΝΙΑΣ", "ΖΑΚΥΝΘΟΥ", "ΛΕΥΚΑΔΑΣ", "ΙΘΑΚΗΣ",
    ]),
    "crete": ("Κρήτη", "Crete", [
        "ΗΡΑΚΛΕΙΟΥ", "ΛΑΣΙΘΙΟΥ", "ΡΕΘΥΜΝΟΥ", "ΧΑΝΙΩΝ",
    ]),
    "dodecanese": ("Δωδεκάνησα", "Dodecanese", [
        "ΚΑΛΥΜΝΟΥ", "ΚΑΡΠΑΘΟΥ", "ΚΩ", "ΡΟΔΟΥ",
    ]),
    "cyclades": ("Κυκλάδες", "Cyclades", [
        "ΑΝΔΡΟΥ", "ΘΗΡΑΣ", "ΚΕΑΣ - ΚΥΘΝΟΥ", "ΜΗΛΟΥ", "ΜΥΚΟΝΟΥ", "ΝΑΞΟΥ",
        "ΠΑΡΟΥ", "ΣΥΡΟΥ", "ΤΗΝΟΥ",
    ]),
    "north_aegean": ("Νησιά Βορείου Αιγαίου", "North Aegean Islands", [
        "ΛΕΣΒΟΥ", "ΛΗΜΝΟΥ", "ΙΚΑΡΙΑΣ", "ΣΑΜΟΥ", "ΧΙΟΥ",
    ]),
}
